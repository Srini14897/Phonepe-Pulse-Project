...
# DATASETS
Data_Aggregated_Transaction_df= pd.read_csv(r'Phonepe-Pulse-Project/data/Aggregate_transaction_table.csv')
Data_Aggregated_User_Summary_df= pd.read_csv(r'Phonepe-Pulse-Project/data/Data_Aggregated_User_Summary_Table.csv')
Data_Aggregated_User_df= pd.read_csv(r'Phonepe-Pulse-Project/data/Data_Aggregated_User_Table.csv')
Scatter_Geo_Dataset =  pd.read_csv(r'Phonepe-Pulse-Project/data/Data_Map_Districts_Longitude_Latitude.csv')
Coropleth_Dataset =  pd.read_csv(r'Phonepe-Pulse-Project/data/Data_Map_IndiaStates_TU.csv')
Data_Map_Transaction_df = pd.read_csv(r'Phonepe-Pulse-Project/data/Data_Map_Transaction_Table.csv')
Data_Map_User_Table= pd.read_csv(r'Phonepe-Pulse-Project/data/Data_Map_User_Table.csv')
Indian_States= pd.read_csv(r'Phonepe-Pulse-Project/data/Longitude_Latitude_State_Table.csv')
...
with coliT1:
    ...
    - Hover data will show details of Total transactions,etc.,
    """
    )
with coliT2:
    st.info(
...
with tab1:
    ...
    st.write('### :green[STATE & PAYMENT MODE]')
...
with tab3:
    ...
    fig4= px.bar(b, x='brand', y='Registered Users Count',color="Registered Users Count",
...
#st.sidebar.markdown("<h1 style='color: green;'>PHONEPE PULSE</h1>", unsafe_allow_html=True)
st.sidebar.markdown("<h1 style='color: BLACK;'>TOP 3 STATES DATA</h1>", unsafe_allow_html=True)
c1,c2=st.columns(2)
with c1:
...
rt=top_states_r[1:4]
st.sidebar.markdown("#### :green[PhonePeApp Openings]")
st.sidebar.markdown(rt[[ 'State','Registered_Users']].style.hide(axis="index").to_html(), unsafe_allow_html=True)
at=top_states_a[1:4]
st.sidebar.markdown("#### :green[PhonePeApp Openings]")
st.sidebar.markdown(at[['State','AppOpenings']].style.hide(axis="index").to_html(), unsafe_allow_html=True)
st.sidebar.markdown("#### :green[Total Transactions]")
st.sidebar.write(x[['Total_Transactions_count']][1:4])
st.sidebar.markdown("#### :green[Total Amount]")
st.sidebar.write(y['Total_Amount'][1:4])      
